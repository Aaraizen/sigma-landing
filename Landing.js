...
document.getElementById("span-holder1").onclick = function(){
    document.getElementById("sub-words").classList.toggle("show");
...
document.getElementById("sub-post").onclick = function(){
    ...
    document.getElementById("sub-navbar1").style.display = "flex";
...
document.getElementById("sub-About").onclick = function(){
    ...
    document.getElementById("sub-navbar1").style.display = "none";
    document.getElementById("posts-section").style.display = "none";
    document.getElementById("blog-section").style.display = "none";
}
